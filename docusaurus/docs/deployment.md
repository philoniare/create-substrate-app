...
You don’t necessarily need a static server in order to run a Create Substrate App project in production. It also works well when integrated into an existing server side app.
...
The choice of your server software isn’t important either. Since Create Substrate App is completely platform-agnostic, there’s no need to explicitly use Node.

The `build` folder with static assets is the only output produced by Create Substrate App.
...
By default, Create Substrate App produces a build assuming your app is hosted at the server root.
...
This will let Create Substrate App correctly infer the root path to use in the generated HTML file.
...
1. Connect your Create Substrate App repo and pick a branch. If you're looking for a Create Substrate App+Amplify starter, try the [create-react-app-auth-amplify starter](https://github.com/swaminator/create-react-app-auth-amplify) that demonstrates setting up auth in 10 minutes with Create Substrate App.
...
Use the [Heroku Buildpack for Create Substrate App](https://github.com/heroku/heroku-buildpack-nodejs).
...
Deploy your app in only a few minutes by following the [Create Substrate App deployment guide](https://render.com/docs/deploy-create-react-app).
...
Create Substrate App doesn't provide any built-in functionality to publish a component to npm. If you're ready to extract a component from your project so other people can use it, we recommend moving it to a separate directory outside of your project and then using a tool like [nwb](https://github.com/insin/nwb#react-components-and-libraries) to prepare it for publishing.
